#ifndef DUNE_FOAMGRID_IMPL_HH
#define DUNE_FOAMGRID_IMPL_HH

namespace Dune {

// Refine the grid uniformly
template <int dimgrid, int dimworld, class ctype>
void FoamGrid<dimgrid, dimworld, ctype>::globalRefine (int refCount)
{
  willCoarsen=false;
...
template <int dimgrid, int dimworld, class ctype>
bool FoamGrid<dimgrid, dimworld, ctype>::preAdapt()
{
...
template <int dimgrid, int dimworld, class ctype>
bool FoamGrid<dimgrid, dimworld, ctype>::adapt()
{
...
template <int dimgrid, int dimworld, class ctype>
void FoamGrid<dimgrid, dimworld, ctype>::postAdapt()
{
  willCoarsen=false;
...
template <int dimgrid, int dimworld, class ctype>
void FoamGrid<dimgrid, dimworld, ctype>::erasePointersToEntities(std::list<FoamGridEntityImp<dimgrid, dimgrid, dimworld, ctype> >& elements)
{
...
template <int dimgrid, int dimworld, class ctype>
template <int i>
void FoamGrid<dimgrid, dimworld, ctype>::eraseVanishedEntities(std::list<FoamGridEntityImp<i, dimgrid, dimworld, ctype> >& levelEntities)
{
...
template <int dimgrid, int dimworld, class ctype>
void FoamGrid<dimgrid, dimworld, ctype>::coarsenSimplexElement(FoamGridEntityImp<dimgrid, dimgrid, dimworld, ctype>& element)
{
...
template <int dimgrid, int dimworld, class ctype>
void FoamGrid<dimgrid, dimworld, ctype>::overwriteFineLevelNeighbours(FoamGridEntityImp<dimgrid-1, dimgrid, dimworld, ctype>& facet,
...
template <int dimgrid, int dimworld, class ctype>
void FoamGrid<dimgrid, dimworld, ctype>::setIndices()
{
  // //////////////////////////////////////////
...
template <int dimgrid, int dimworld, class ctype>
bool FoamGrid<dimgrid, dimworld, ctype>::preGrow()
...
template <int dimgrid, int dimworld, class ctype>
bool FoamGrid<dimgrid, dimworld, ctype>::grow()
{
...
template <int dimgrid, int dimworld, class ctype>
void FoamGrid<dimgrid, dimworld, ctype>::addElementForFacet(const FoamGridEntityImp<dimgrid, dimgrid, dimworld, ctype>* element,
...
template <int dimgrid, int dimworld, class ctype>
bool FoamGrid<dimgrid, dimworld, ctype>::removeSimplexElement(FoamGridEntityImp<dimgrid, dimgrid, dimworld, ctype>& element)
{
...
template <int dimgrid, int dimworld, class ctype>
void FoamGrid<dimgrid, dimworld, ctype>::setPosition(const typename Traits::template Codim<dimgrid>::Entity & e,
                                                    const FieldVector<ctype, dimworld>& pos)
{
  auto vertex = const_cast<FoamGridEntityImp<0, dimgrid, dimworld, ctype>*>(e.impl().target_);

  if (!vertex->isLeaf())
    DUNE_THROW(NotImplemented, "Moving vertices that are not on the leaf!");
